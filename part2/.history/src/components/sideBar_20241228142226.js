...
const Sidebar = ({ username, controlSideBar, logout }) => {

  useEffect(() => {
    // Initialize the sidebar with the Overview section
    controlSideBar('Overview');
  }, [controlSideBar]);
  ...
  return (
    <nav id="sideBar">
      <ul>
        <li className="header">
          <span className="sections-header">Dashboard</span>
        </li>
        <li>
          <a
            href="#"
            className="sections-name"
            onClick={() => controlSideBar('Overview')}
          >
            <svg
          ...
          <a
            href="#"
            className="sections-name"
            onClick={() => controlSideBar('Village-Management')}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
          ...
          <a
            href="#"
            className="sections-name"
            onClick={() => controlSideBar('Gallery')}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
