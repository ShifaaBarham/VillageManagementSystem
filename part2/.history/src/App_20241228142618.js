    ...
    return (
        <nav id="sideBar">
            <ul>
                ...
                <li>
                    <NavLink to="/Overview" className="sections-name">
                    ...
                    <NavLink to="/VellageManagement" className="sections-name">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                    ...
                    <NavLink to="/Chat" className="sections-name">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                            <path d="M240-400h320v-80H240v80Zm0-120h480v-80H240v80Zm0-120h480v-80H240v80ZM80-80v-720q0-33 23.5-56.5T160-880h640q33 0 56.5 23.5T880-800v480q0 33-23.5 56.5T800-240H240L80-80Zm126-240h594v-480H160v525l46-45Zm-46 0v-480 480Z" />
                        </svg>
                        <span>Chat</span>
                    </NavLink>
                    <NavLink to="/Gallery" className="sections-name">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
            ...
            <li id="account-section">
                ...
                <button id="logout-button" onClick={() => alert("Logging out...")}>Log Out</button>
            </li>
        </nav>
    );
};
